...
/*   Updated: 2022/12/17 15:27:27 by kyoulee          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (ref_1.toFloat() > ref_2.toFloat())
		return (ref_1);
	return (ref_2);
}
...
const Fixed&	Fixed::max(Fixed const &ref_1, Fixed const &ref_2)
{
	if (ref_1.toFloat() > ref_2.toFloat())
		return (ref_1);
	return (ref_2);
...
const Fixed& 	Fixed::min(Fixed const &ref_1, Fixed const &ref_2)
{
	if (ref_1.toFloat() < ref_2.toFloat())
		return (ref_1);
	return (ref_2);
